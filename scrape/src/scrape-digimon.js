...
const DEFAULT_INPUT = path.join(SCRAPER_DIR, 'digimon.json');
const DEFAULT_OUTPUT = path.join(SCRAPER_DIR, 'digimon-enriched.json');
const DEFAULT_CACHE = path.join(SCRAPER_DIR, '.cache', 'scrape-cache.json');
const DEFAULT_IMAGES_DIR = path.join(SCRAPER_DIR, 'src', 'images');
